...
public class WakaAuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {

    private String defaultFailureUrl;

    public WakaAuthenticationFailureHandler() {
        super();
    }

    public WakaAuthenticationFailureHandler(String defaultFailureUrl) {
