...
import com.wakacommerce.common.sandbox.domain.SandBoxManagement;
import com.wakacommerce.common.sandbox.domain.SandBoxManagementImpl;
...
public class SandBoxDaoImpl implements SandBoxDao {
    ...
    public SandBox retrieve(Long id) {
        ...
        //(i.e. org.hibernate.HibernateException: Found two representations of same collection: com.wakacommerce.core.catalog.domain.ProductImpl.additionalSkus
    ...
    public Map<Long, String> retrieveAuthorNamesForSandBoxes(Set<Long> sandBoxIds) {
        Query query = sandBoxEntityManager.createQuery(
                ...
                "FROM com.wakacommerce.common.sandbox.domain.SandBoxManagementImpl sb, " +
                    "com.wakacommerce.openadmin.server.security.domain.AdminUserImpl au " +
