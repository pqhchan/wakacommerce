...
public class AdminSecurityServiceRemote implements AdminSecurityService, SecurityVerifier {
    ...
    protected com.wakacommerce.openadmin.server.security.service.AdminSecurityService securityService;
    ...
    @Override
    public com.wakacommerce.openadmin.server.security.remote.AdminUser getAdminUser() throws ServiceException {
        AdminUser persistentAdminUser = getPersistentAdminUser();
        if (persistentAdminUser != null) {
            com.wakacommerce.openadmin.server.security.remote.AdminUser response = new com.wakacommerce.openadmin.server.security.remote.AdminUser();
