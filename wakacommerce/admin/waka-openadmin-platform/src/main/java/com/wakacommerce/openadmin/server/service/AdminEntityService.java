...
public interface AdminEntityService {
    ...
    /**
     * Thin layer on top of {@link DynamicEntityService#add(com.wakacommerce.openadmin.dto.PersistencePackage)} that
     ...
     * of {@link DynamicEntityRemoteService#add(com.wakacommerce.openadmin.dto.PersistencePackage)} in situations
    ...
    /**
     * Thin layer on top of {@link DynamicEntityService#update(com.wakacommerce.openadmin.dto.PersistencePackage)}
     * @param request
     * @return
     * @throws ServiceException if there were exceptions other than a {@link ValidationException} that was thrown as a
     ...
     * of {@link DynamicEntityRemoteService#update(com.wakacommerce.openadmin.dto.PersistencePackage)} in situations
     * where you want to manage the transactions in a parent component
     * 
     * @param request
     * @param transactional
    ...
    /**
     * Thin layer on top of {@link DynamicEntityService#inspect(com.wakacommerce.openadmin.dto.PersistencePackage)}
     * @param request
     * @return
     * @throws ServiceException
     */
    ...
    /**
     * Thin layer on top of {@link DynamicEntityService#remove(com.wakacommerce.openadmin.dto.PersistencePackage)}
     * @param request
     * @return
     * @throws ServiceException
     */
     ...
     * of {@link DynamicEntityRemoteService#remove(com.wakacommerce.openadmin.dto.PersistencePackage)} in situations
     * where you want to manage the transactions in a parent component
     * 
     * @param request
     * @param transactional
    ...
    /**
     * Thin layer on top of {@link DynamicEntityService#fetch(com.wakacommerce.openadmin.dto.PersistencePackage, com.wakacommerce.openadmin.dto.CriteriaTransferObject)}.
