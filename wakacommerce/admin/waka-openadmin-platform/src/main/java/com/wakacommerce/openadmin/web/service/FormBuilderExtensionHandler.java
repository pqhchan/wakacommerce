...
public interface FormBuilderExtensionHandler extends ExtensionHandler {
     ...
     * @see {@link FormBuilderService#populateEntityForm(com.wakacommerce.openadmin.dto.ClassMetadata, EntityForm)}
     * @return
     */
     ...
     * @see {@link FormBuilderService#populateEntityForm(com.wakacommerce.openadmin.dto.ClassMetadata, Entity, EntityForm)}
     */
     ...
     * @return whether or not it was handled
     * @see {@link FormBuilderService#populateEntityForm(com.wakacommerce.openadmin.dto.ClassMetadata, com.wakacommerce.openadmin.dto.Entity, java.util.Map, EntityForm)
     */
