...
import com.wakacommerce.common.presentation.override.AdminPresentationMapOverride;
...
public class MapFieldMetadataProvider extends AdvancedCollectionFieldMetadataProvider {
    ...
    protected void buildMapMetadata(Class<?> parentClass, Class<?> targetClass, Map<String, FieldMetadata> attributes,
        ...
        com.wakacommerce.openadmin.dto.OperationTypes dtoOperationTypes = new com.wakacommerce.openadmin.dto.OperationTypes(OperationType.MAP, OperationType.MAP, OperationType.MAP, OperationType.MAP, OperationType.MAP);
