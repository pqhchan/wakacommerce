...
import com.wakacommerce.common.util.HibernateUtils;
...
import com.wakacommerce.core.offer.domain.CandidateItemOfferImpl;
import com.wakacommerce.core.offer.domain.OrderItemAdjustment;
import com.wakacommerce.core.offer.domain.OrderItemAdjustmentImpl;
...
public class OrderItemImpl implements OrderItem, Cloneable, AdminMainEntity, CurrencyCodeIdentifiable, MultiTenantCloneable<OrderItemImpl> {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.wakacommerce.core.order.domain.OrderItemImpl")
        }
    )
    ...
    public void checkCloneable(OrderItem orderItem) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("com.wakacommerce") &&
                !orderItem.getClass().getName().startsWith("com.wakacommerce")) {
