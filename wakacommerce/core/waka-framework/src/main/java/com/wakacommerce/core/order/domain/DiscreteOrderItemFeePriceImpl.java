...
public class DiscreteOrderItemFeePriceImpl implements DiscreteOrderItemFeePrice  {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.wakacommerce.core.order.domain.DiscreteOrderItemFeePriceImpl")
        }
    )
    ...
    public void checkCloneable(DiscreteOrderItemFeePrice discreteFeePrice) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("com.wakacommerce") && !discreteFeePrice.getClass().getName().startsWith("com.wakacommerce")) {
