...
public class CandidateItemOfferImpl implements CandidateItemOffer, Cloneable {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.wakacommerce.core.offer.domain.CandidateItemOfferImpl")
        }
    )
    ...
    public void checkCloneable(CandidateItemOffer itemOffer) throws CloneNotSupportedException, SecurityException, NoSuchMethodException {
        ...
        if (cloneMethod.getDeclaringClass().getName().startsWith("com.wakacommerce") && !itemOffer.getClass().getName().startsWith("com.wakacommerce")) {
