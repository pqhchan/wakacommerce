...
import com.wakacommerce.core.offer.service.discount.ItemOfferComparator;
import com.wakacommerce.core.offer.service.discount.ItemOfferQtyOneComparator;
import com.wakacommerce.core.offer.service.discount.OrderOfferComparator;
...
public class ItemOfferProcessorImpl extends OrderOfferProcessorImpl implements ItemOfferProcessor, ItemOfferMarkTargets {
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.core.offer.service.processor.ItemOfferProcessor#filterItemLevelOffer(com.wakacommerce.core.order.domain.Order, java.util.List, java.util.List, com.wakacommerce.core.offer.domain.Offer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.core.offer.service.processor.ItemOfferProcessor#applyAllItemOffers(java.util.List, java.util.List)
     */
    @Override
