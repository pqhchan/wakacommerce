...
import com.wakacommerce.common.config.domain.AbstractModuleConfiguration;
...
public class TaxDetailImpl implements TaxDetail {
    ...
    @GenericGenerator(
        ...
        parameters = {
            ...
            @Parameter(name="entity_name", value="com.wakacommerce.core.catalog.domain.TaxDetailImpl")
        }
    )
