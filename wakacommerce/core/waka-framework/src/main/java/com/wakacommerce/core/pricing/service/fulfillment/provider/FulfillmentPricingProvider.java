...
public interface FulfillmentPricingProvider {
     ...
     * returns true. This should call {@link FulfillmentGroup#setShippingPrice(com.wakacommerce.common.money.Money)} to
     ...
     * {@link #canCalculateCostForFulfillmentGroup(com.wakacommerce.core.order.domain.FulfillmentGroup, com.wakacommerce.core.order.domain.FulfillmentOption)}
