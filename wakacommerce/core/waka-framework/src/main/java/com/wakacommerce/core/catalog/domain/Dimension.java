...
public class Dimension implements Serializable {
    ...
    @Column(name = "WIDTH")
    @AdminPresentation(friendlyName = "Dimension_width", order = 2000,
    ...
    @AdminPresentation(friendlyName = "Dimension_containerShape", order = 7000,
        tab = ProductImpl.Presentation.Tab.Name.Shipping, 
        tabOrder = ProductImpl.Presentation.Tab.Order.Shipping,
        group = ProductImpl.Presentation.Group.Name.Shipping, 
        groupOrder = ProductImpl.Presentation.Group.Order.Shipping,
    ...
    @AdminPresentation(friendlyName = "Dimension_dimensionUnitOfMeasure", order = 8000,
        tab = ProductImpl.Presentation.Tab.Name.Shipping, 
        tabOrder = ProductImpl.Presentation.Tab.Order.Shipping,
        group = ProductImpl.Presentation.Group.Name.Shipping, 
        groupOrder = ProductImpl.Presentation.Group.Order.Shipping,
