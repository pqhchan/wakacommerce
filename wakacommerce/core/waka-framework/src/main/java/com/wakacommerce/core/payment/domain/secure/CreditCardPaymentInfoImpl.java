...
public class CreditCardPaymentInfoImpl implements CreditCardPayment {
    ...
    @GenericGenerator(
            ...
            parameters = {
                ...
                @Parameter(name="entity_name", value="com.wakacommerce.core.payment.domain.CreditCardPaymentInfoImpl")
            }
        )
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getId()
     */
    @Override
    public Long getId() {
        return id;
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setId(long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getReferenceNumber()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setReferenceNumber(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getPan()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setPan(java.lang.Long)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getExpirationMonth()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setExpirationMonth(java.lang.Integer)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getExpirationYear()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setExpirationYear(java.lang.Integer)
     */
    @Override
    ...
    /* (non-Javadoc)
    * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#getNameOnCard()
    */
    @Override
    ...
    /* (non-Javadoc)
    * @see com.wakacommerce.profile.payment.secure.domain.CreditCardPaymentInfo#setNameOnCard(java.lang.String)
    */
    @Override
