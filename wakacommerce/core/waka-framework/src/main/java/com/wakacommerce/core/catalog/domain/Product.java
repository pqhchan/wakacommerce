...
public interface Product extends Serializable, MultiTenantCloneable<Product> {
    ...
    /**
     * Return the {@link com.wakacommerce.core.catalog.domain.Category} that contains this product
     *
     * @return
     */
    ...
    /**
     * Set the {@link com.wakacommerce.core.catalog.domain.Category} that contains this product
     *
     * @param category
     */
